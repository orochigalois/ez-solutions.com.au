...
<?php } ?>
  <div class="container">
      <div class="banner_inner">
          <h2><?php printf( esc_html__( 'Search Results for: %s', 'sorbroix' ), get_search_query() ); ?></h2>
      </div>
  </div>
</section>
<!--================End Banner Area =================-->
  ...
  <div class="container">
     ...
     ?>
            ...
            <div class="search-custom" ><h4><?php
                            ...
                            echo esc_html__( 'Sorry, but nothing matched your search terms. Please try again with some different keywords.', 'sorbroix' ) ;?></h4>
