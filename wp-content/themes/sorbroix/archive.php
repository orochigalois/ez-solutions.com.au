...
<?php } ?>
  <div class="container">
      <div class="banner_inner">
          <h2><?php
                        if ( is_day() ) :
                            printf( esc_html__( 'Daily Archives: %s', 'sorbroix' ), get_the_date() );

                        elseif ( is_month() ) :
                            printf( esc_html__( 'Monthly Archives: %s', 'sorbroix' ), get_the_date( _x( 'F Y', 'monthly archives date format', 'sorbroix' ) ) );

                        elseif ( is_year() ) :
                            printf( esc_html__( 'Yearly Archives: %s', 'sorbroix' ), get_the_date( _x( 'Y', 'yearly archives date format', 'sorbroix' ) ) );

                        else :
                            echo esc_html__( 'Archives', 'sorbroix' );
